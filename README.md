...
- **Pretrained model weights (.pt files):** due to large file sizes, all trained weights for **PODNO** and **FNO** are also stored in the same OneDrive link above for reference.
