...
|:------------:|:---------|:-------|:----------|:--------------|
| **NLS** | `/NLS/pNLS_data.mat` | `u_re1`<br>`u_im1`<br>`u_re2`<br>`u_im2`<br>`p1` | (64, 64, 1000)<br>(64, 64, 1000)<br>(64, 64, 1000)<br>(64, 64, 1000)<br>(1, 1000) | real part of the initial condition<br>imaginary part of the initial condition<br>real part of the solution<br>imaginary part of the solution<br>the constant coefficients |
...
| **Darcy** | `/Darcy/piececonst_r421_`<br>`N1024_smooth1.mat` | `coeff`<br>`sol` | (1000, 421, 421)<br>(1000, 421, 421) | permeability field<br>solution |
